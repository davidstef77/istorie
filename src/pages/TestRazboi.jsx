...
import quizData from "../components/data/razboaie.json"; 
...
const TestRazboi = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 space-y-12">
      <h1 className="text-5xl font-serif text-white drop-shadow-lg text-center mb-12">Test despre război</h1>
              ...
              <div className="space-y-4">
                {question.options.map((option, idx) => (
                  <button
                    ...
                    className={`w-full p-4 bg-gray-700 text-white rounded-md hover:bg-gray-600 transition-all duration-300 ${answers[index] === option ? 'bg-gray-600' : ''}`}
                  >
                    {option}
                  </button>
                ))}
